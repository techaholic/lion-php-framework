...
<table border="0" cellpadding="0" style="border-collapse: collapse" width="95%">
    <tr>
        ...
        <tr><td valign="bottom" nowrap><font class="very_big_title"><comp:resource key="welcome_title"/></font></td></tr>
        ...
        <tr><td valign="top" align="right" nowrap><comp:resource key="welcome_subtitle"/></td></tr></table>
        <br><br>
        {$welcome_message}
        </td>
    </tr>

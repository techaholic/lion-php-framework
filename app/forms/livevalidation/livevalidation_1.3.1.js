...
LiveValidation.prototype = {
  ...
  validateElement: function(validationFunction, validationParamsObj){
    ...
    if(this.element['exampleValue'] && this.element['exampleValue'] == value) {
    	value = null;
    }
   ...
   */
  validate: function(){
  	if(!this.element.disabled && this.element.visible()){
...
var Validate = {
  ...
  AllowedFileExtensions: function(value, paramsObj){
    var value = String(value);
    if(value === '' || value === null || value === undefined) {
        return true;
    }
    var params = Object.extend({ 
      failureMessage: "File type not allowed",
      allowedExtensions: /./
    }, paramsObj || {});

    if(!value.match(params.allowedExtensions)) Validate.fail(params.failureMessage);
